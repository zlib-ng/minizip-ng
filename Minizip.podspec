...
DESC
  ...
  s.subspec 'Core' do |sp|
    sp.source_files = '{mz,mz_os,mz_os_posix,mz_compat,mz_crypt,mz_strm,mz_strm_mem,mz_strm_buf,mz_strm_crypt,mz_strm_zlib,mz_zip,mz_zip_rw,mz_strm_split}.{c,h}', 'mz_strm_os.h', 'mz_strm_os_posix.c'
