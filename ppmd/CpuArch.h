...
#if defined(MY_CPU_AMD64) || defined(_M_IA64) || defined(__AARCH64EL__) || defined(__AARCH64EB__)
#  define MY_CPU_64BIT
#endif
...
#if defined(MY_CPU_X86) || defined(_M_ARM) || defined(__ARMEL__) || defined(__THUMBEL__) || defined(__ARMEB__) ||      \
    defined(__THUMBEB__)
#  define MY_CPU_32BIT
#endif
...
#  define MY_CPU_IA64_LE
    ...
    defined(__ARMEL__) || defined(__THUMBEL__) || defined(__AARCH64EL__) || defined(__MIPSEL__) ||                     \
    defined(__MIPSEL) || defined(_MIPSEL) || (defined(__BYTE_ORDER__) && (__BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__))
#  define MY_CPU_LE
#endif
    ...
    defined(__s390x__) || defined(__zarch__) || defined(__sparc) ||                                                    \
